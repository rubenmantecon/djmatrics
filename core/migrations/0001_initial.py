...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('request_num', models.CharField(max_length=100, verbose_name='Número de sol·licitud')),
                ('ralc_num', models.CharField(max_length=100, verbose_name='Identificador RALC')),
                ('first_name', models.CharField(max_length=100, verbose_name='nom')),
                ('last_name_1', models.CharField(max_length=100, verbose_name='cognom 1')),
                ('last_name_2', models.CharField(max_length=100, verbose_name='cognom 2')),
                ('ID_num', models.CharField(help_text='Número del DNI, NIE o Passaport', max_length=30, verbose_name='ID num')),
                ('ID_type', models.CharField(choices=[('DNI', 'DNI'), ('NIE', 'NIE'), ('PASS', 'Passaport')], max_length=30, verbose_name='tipus de doc ID')),
                ('tis', models.CharField(blank=True, default=None, max_length=20, null=True, verbose_name='Targeta Sanitària')),
                ...
                ('tutor_1_dni', models.CharField(default=None, max_length=30, null=True, verbose_name='dni del pare/mare o tutor/a legal (1)')),
                ('tutor_1_name', models.CharField(default=None, max_length=50, null=True, verbose_name='nom del pare/mare o tutor/a legal (1)')),
                ('tutor_1_lastname1', models.CharField(default=None, max_length=50, null=True, verbose_name='cognoms del pare/mare o tutor/a legal (1)')),
                ('tutor_1_lastname2', models.CharField(default=None, max_length=50, null=True, verbose_name='cognoms del pare/mare o tutor/a legal (1)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.CharField(blank=True, choices=[('EX', 'Exempció'), ('BO', 'Bonificació'), ('MA', 'Obligatori')], default=None, max_length=20, null=True, verbose_name='tipus')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('P', 'Pendent'), ('V', 'Validat'), ('R', 'Rebutjat')], default=None, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='nom')),
                ('code', models.CharField(max_length=20, verbose_name='codi')),
                ('course', models.CharField(choices=[('1', '1r'), ('2', '2n')], default=None, max_length=20, null=True, verbose_name='primer o segon')),
