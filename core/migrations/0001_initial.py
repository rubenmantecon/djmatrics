    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_type', models.CharField(blank=True, choices=[('EX', 'Exempció'), ('BO', 'Bonificació'), ('MA', 'Obligatori')], default=None, max_length=20, null=True, verbose_name='profile_type')),
            ],
            options={
