    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[(core.models.ValidationState['P'], 'Pending'), (core.models.ValidationState['V'], 'Validated'), (core.models.ValidationState['U'], 'Unregistered')], default=None, max_length=20)),
                ...
                ('email', models.EmailField(max_length=254, verbose_name='correu')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[(core.models.Req_EnrolState['P'], 'Pending'), (core.models.Req_EnrolState['V'], 'Validated'), (core.models.Req_EnrolState['R'], 'Rejected'), (core.models.Req_EnrolState['E'], 'Empty')], default=None, max_length=20)),
